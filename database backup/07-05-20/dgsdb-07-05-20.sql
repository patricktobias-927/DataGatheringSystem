...
) ENGINE=InnoDB AUTO_INCREMENT=264 DEFAULT CHARSET=latin1 COMMENT='Table For guardian information';
...
) ENGINE=InnoDB AUTO_INCREMENT=541 DEFAULT CHARSET=latin1 COMMENT='Table for parents information. ';
...
CREATE TABLE IF NOT EXISTS `tbl_parentuser` (
  ...
  `usertype` tinytext,
  PRIMARY KEY (`userID`)
) ENGINE=InnoDB AUTO_INCREMENT=265 DEFAULT CHARSET=latin1 COMMENT='User list for parent only';
...
CREATE TABLE IF NOT EXISTS `tbl_schoolinfo` (
  ...
  `averageGrade` varchar(6) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=618 DEFAULT CHARSET=latin1 COMMENT='Tables for sibling information';
...
) ENGINE=InnoDB AUTO_INCREMENT=7247 DEFAULT CHARSET=latin1 COMMENT='Student main information.';
