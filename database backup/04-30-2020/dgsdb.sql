...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='Table For guardian information';
...
CREATE TABLE IF NOT EXISTS `tbl_parents` (
  ...
  `employerAddress` varchar(180) NOT NULL DEFAULT '',
  `isFather` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1=true',
  PRIMARY KEY (`parentID`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=latin1 COMMENT='Table for parents information. ';
...
CREATE TABLE IF NOT EXISTS `tbl_parentuser` (
  ...
  PRIMARY KEY (`userID`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1 COMMENT='User list for parent only';
...
CREATE TABLE IF NOT EXISTS `tbl_schoolinfo` (
  ...
  `levelCompleted` varchar(50) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1 COMMENT='Tables for sibling information';
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 COMMENT='Student main information.';
