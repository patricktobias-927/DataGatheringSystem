...
<!-- nav bar & side bar -->
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
<?php           $sql = "select a.Firstname, a.Lastname, a.Middlename, a.studentID,a.studentCode,a.lrn, a.schoolYearID, b.schoolYear  FROM tbl_student as a inner join tbl_schoolyear as b on a.schoolYearID = b.schoolYearID where userID =".$userID." AND b.schoolyearid < ".$schoolYearID;
           $result1 = mysqli_query($conn, $sql);
            $ctr=0;
              if (mysqli_num_rows($result1) > 0) {?>
      <!-- Default box -->
